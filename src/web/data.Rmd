...
**The Relationship Between Organizational Characteristics and Team Building Success**   
- A publication by researchers at the University of Akron exploring the influence of organizational structure and team building on workgroup effectiveness written for the general public and other academics 
...
###*LDA*
LDA can be used to see the top topics that come out of a given corpus. From our project, we selected tehre to be 18 topics. The titles on each topic group were assigned based on the theme each topic appears to be attempting to convey. Some topics, such as Shared Vision, appear multiple times.
...
###*Co-Occurence*
By looking at the word co-occurance map, the frequency at which different terms appear together is shown. Some of the highest frequency sets include leader and subordiante, army and leader, and team and member. This shows that the documents selected reflected the overall theme of an individual's role in unit performance. Interesting connections include those formed between leader and situation, organizational and leader, and time and leader. 
# ```{r, layout="l-body-outset", echo = FALSE}
# library(rmarkdown)
