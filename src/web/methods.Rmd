...
=======
10 documents were selected to be from a variety of sources, sectors, and time periods. Documents most relevant to the theme were chosen.The documents selected can be found [here](https://github.com/uva-bi-sdad/dspg22ari2/tree/main/data/txt_files).
>>>>>>> fc2b74f3f05a6e7fdcf397ac53d72d332801abbf
...
#**5. Primary Reading**  
![Word Cloud](www/word_cloud.PNG){width=60% }</center>  
...
![Coder Test](www/code_test.PNG)(www/word_cloud.PNG){width=90% }</center>
